...
public class GuiMinechemManual extends GuiScreen{
    ...
    private static final ResourceLocation manualMainText = new ResourceLocation(MRef.MID, "text/manual.txt");
    private static final ResourceLocation manualDimensionText = new ResourceLocation(MRef.MID, "text/manual_dimension.txt");
    private static final ResourceLocation iconGuiElements = new ResourceLocation(MRef.MID, "textures/gui/guielements.png");

    public GuiMinechemManual(int manual){
    ...
    public void initGui(){
        ...
        textPage = new TextPage(Minechem.instance, mc, this).setText(manualText).setArrowImage(iconGuiElements, 144, 0).setCraftingGridImage(iconGuiElements, 0, 192);

        prevButton = new Button(mc, this).setText("<").addButtonEvent(new ButtonEvent(){
            @Override
            public void buttonClicked(Widget parent){
                System.out.println("GuiMinechemManual.buttonClicked: <");
                textPage.prevPage();
